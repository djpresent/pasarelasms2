...
<head>
  ...
  <%
	...
	ResultSet rs = conn.createStatement().executeQuery(
	    "SELECT * FROM pasarelasms.servicio,pasarelasms.servicio_usuario where servicio.idservicio = servicio_usuario.idservicio and servicio_usuario.idusuario="+u.getId()+";");
  	...
  	<div class="container-fluid">
	  	<div class="row">
			...
			<div class="col-sm-9 col-md-9 main">
				...
				<form onsubmit="return verificarServicio();"  action="/reporteUsuariosTransacciones">
